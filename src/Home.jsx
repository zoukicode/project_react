   ...
   {/* navigation */}
    ...
    >
      ...
      <motion.div
        ...
        className='md:w-[300px] items-center rounded-md w-[70%] bg-[#f5f5f5] relative shadow-[0 0 1px rgba(0,0,0,0.075), 0 0 2px rgba(0,0,0,0.075), 0 0 4px rgba(0,0,0,0.075), 0 0 8px rgba(0,0,0,0.075), 0 0 16px rgba(0,0,0,0.075)]
          overflow-visible'
      >
